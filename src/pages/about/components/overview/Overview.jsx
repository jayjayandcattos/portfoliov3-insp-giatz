      ...
      <div className={styles.desc}>
        {!isMobile ? (
          <AppearTitle key="desktop-overview">
            <h6 className="h6">Hey there! I&apos;m a 26-year-old front-end developer with a </h6>
            ...
            <h6 className={clsx(styles.paddingTop, 'h6')}>Justin Rivera.</h6>
          </AppearTitle>
        ) : (
          <AppearTitle key="mobile-overview">
            <h6 className="h6">Hey there! I&apos;m a 26-year-old front-end developer </h6>
